...
def categorizer_data(db_session):
    ...
    t1 = Transaction(transaction_id="1", account_id="a1", date=d1, name="Starbucks 123", amount=5.0, pending=False, merchant_name="Starbucks")
    t2 = Transaction(transaction_id="2", account_id="a1", date=d2, name="Starbucks 456", amount=6.0, pending=False, merchant_name="Starbucks")
    t3 = Transaction(transaction_id="3", account_id="a1", date=d3, name="Unknown Store", amount=10.0, pending=False) # No merchant
